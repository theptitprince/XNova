...
<tr>
	...
	<td class="b" style="color:#FFFFFF">{adm_ov_lastv}: <b><a style="color:orange;" href="https://github.com/theptitprince/XNova/releases" target="_blank" rel="noopener">{adm_ov_here}</a></b></td>
</tr>
</table>
<br>
<table width="98%">
