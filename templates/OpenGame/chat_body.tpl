...
<tr><th width="60"><b>{chat_text}</b><br><i>{chat_text}</i><br><u>{chat_text}</u><br><a href="https://example.com" target="_blank" rel="noopener">{chat_text}</a><br><font color="red">{chat_text}</font></th>

<th>[b]{chat_text}[/b]<br>[i]{chat_text}[/i]<br>[u]{chat_text}[/u]<br>[a=https://example.com]{chat_text}[/a]<br>[c=blue|yellow|green|pink|red|orange]{chat_text}[/c]</th></tr>
